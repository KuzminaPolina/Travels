...
var headerSlider = document.querySelector('.slider');
var focusSlider = function focusSlider(t, e) {
  var links = t.querySelectorAll('.slider__more-button');
  var next = function next(evt) {
    var slides = t.querySelectorAll('.slider__item');
    var o = evt.target.closest('.slider__item');
    var s = Array.from(slides).indexOf(o);
    e.slideTo(s + 1);
  };
...
},{"./modules/form-validate/form":3,"./modules/menu":9,"./modules/modals/init-modals":10,"./modules/video":12,"./utils/ios-vh-fix":15}],2:[function(require,module,exports){
"use strict";
