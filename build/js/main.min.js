...
var _instructors = require("./modules/instructors");
...
var leaflet = function leaflet() {
  var L = window.L;
  var map = L.map('map').setView([55.81322, 37.63729], 12);
...
var initHeaderSlider = function initHeaderSlider() {
  var newHeaderSlider = new Swiper('.slider__container', {
...
var initCatalogSlider = function initCatalogSlider() {
  return new Swiper('.catalog__content', {
    direction: 'horizontal',
    loop: false,
    navigation: {
...
var initFeedbackSlider = function initFeedbackSlider() {
  return new Swiper('.feedback__container', {
    direction: 'horizontal',
    loop: false,
    navigation: {
...
var initDesktopOnlySlider = function initDesktopOnlySlider() {
  var desktopSlider;
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  initHeaderSlider();
  initCatalogSlider();
  (0, _instructors.initInstructorsSlider)();
  initFeedbackSlider();
  initGallerySlider();
...
},{"./modules/form-validate/form":3,"./modules/instructors":9,"./modules/menu":10,"./modules/modals/init-modals":11,"./modules/video":13,"./utils/ios-vh-fix":16}],2:[function(require,module,exports){
"use strict";
...
exports.initInstructorsSlider = void 0;
var Swiper = window.Swiper;
var initInstructorsSlider = function initInstructorsSlider() {
  return new Swiper('.education__content', {
    direction: 'horizontal',
    loop: false,
    navigation: {
...
var navOpen = document.querySelector('.header__menu-button-open');
var navClose = document.querySelector('.header__menu-button-close');
var navbar = document.querySelector('.header__navbar');
var overlay = document.querySelector('.header__overlay');
var wrapper = document.querySelector('.header__another-useless-wrapper');
function openMenu() {
...
var video = document.querySelector('.video__iframe');
var playButton = document.querySelector('.video__button');
var swapVideoUrl = function swapVideoUrl() {
...
var observer = new IntersectionObserver(swapVideoUrl, options);
var target = video;
var playVideo = function playVideo() {
  var onPressPlay = function onPressPlay() {
    if (overlay.classList.contains('video__overlay--open') && video.classList.contains('video__iframe--hidden')) {
